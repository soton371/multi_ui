...
class Shop{
  ...
  Shop(this.name,this.url,this.location,this.description,this.contact,this.ratings);
  ...
  static Future<String> getData()  async{
    ...
    return await rootBundle.loadString('lib/customapps/homemade/data/shops.json');
