import 'package:UIKit/customapps/homemade/controllers/single_shop_controller.dart';
import 'package:UIKit/customapps/homemade/models/category.dart';
...
class _SingleShopScreenState extends State<SingleShopScreen> {
  ...
  void initState() {
    super.initState();
    singleShopController = FxControllerStore()
        .putOrFind<SingleShopController>(SingleShopController());
