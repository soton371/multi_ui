...
class Profile{
  ...
  Profile(this.name,this.image,this.description, this.profession,this.companyName,this.age,this.interests);
  ...
  static Future<String> getData() async {
    return await rootBundle
        .loadString('lib/customapps/dating/data/profile.json');
  }
